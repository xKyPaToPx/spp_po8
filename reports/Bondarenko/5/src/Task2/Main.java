public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (vehicles[0].countTransportationTime(100) >= 0) {
            System.out.println("Автомобиль " + vehicles[0].getModel() + " " + vehicles[0].getSign() + " проедет 100 км за время "
        ...
        if (vehicles[1].countTransportationTime(50) >= 0) {
            System.out.println("Велосипед " + vehicles[1].getModel() + " " + vehicles[1].getSign() + " проедет 50 км за время "
        ...
        if (vehicles[1].countTransportationTime(35) >= 0) {
            System.out.println("Велосипед " + vehicles[2].getModel() + " " + vehicles[2].getSign() + " проедет 35 км за время "
